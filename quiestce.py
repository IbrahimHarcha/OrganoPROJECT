...
class Widget1():
    ...
    def gui(self, parent):
        ...
        photo = PhotoImage(file =  r"C:\Users\SCD UM\Desktop\jeuquiestce\Jouer.png")
...
class Grid(Frame):
    def __init__(self,root):
        ...
        for i in range(0,l):
            for j in range(0,c):
                str=r"C:\Users\SCD UM\Desktop\jeuquiestce\personnages/"+data["possibilites"][s]["fichier"]
...
class Frame2():
    def __init__(self,root):
        ...
        self.cbb3=Combobox(frame,values=["genre","cheveux"])
        self.cbb3.grid(row=2,column=5)
        self.cbb4=Combobox(frame, values=combo)
        ...
        self.cbb3.bind("<<ComboboxSelected>>", combo)
